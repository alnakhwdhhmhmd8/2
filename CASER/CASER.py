...
@app.on_message(filters.command("جلب_نسخه") & filters.private, group=7728230165)
...
@app.on_message(filters.document & filters.private, group=7728230165)
...
@app.on_message(filters.command("ريستارت يوتيوب", "") & filters.private, group=7728230165)
